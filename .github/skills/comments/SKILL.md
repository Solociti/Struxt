...
Inline // comments written by the developer (not generated by an AI agent) documenting intentional non-obvious design decisions are permitted. AI agents must not add, remove or modify these comments unless explicitly asked.
